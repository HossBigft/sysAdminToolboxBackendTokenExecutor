...
@Command(name = "sysadmintoolbox", description = "Safe root wrapper for executing Plesk and Bind administration commands. github.com/HossBigft/sysAdminToolboxBackendTokenExecutor", version = "0.3.6", mixinStandardHelpOptions = true)
